...
```{=html}
<div class="hero-section fade-in" style="background-image: linear-gradient(135deg, var(--surface-color) 0%, rgba(255, 255, 255, 0.8) 100%), url('../arrays_hero.png');">
  <h1>Arrays</h1>
  <p class="lead">The fundamental building blocks of linear data storage. Mastering traversal and manipulation.</p>
</div>
```
