...
# Arrays: Fundamentals and Techniques
...
**When to use:**
- When you need to find a pair of elements that meet certain criteria
- When the array is sorted
- When you need to find subarrays with specific properties
...
**When to use:**
- When the problem involves subarrays/substrings with certain conditions
- When you need to find the longest/shortest subarray with specific properties
- When the array contains only positive numbers (for variable-size window)
